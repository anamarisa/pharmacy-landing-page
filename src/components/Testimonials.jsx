  ...
  const Card = ({ text }) => (
    <div className="px-2">
      <div className="h-[280px] md:h-[246px] w-full text-sm md:text-[18px] flex flex-col justify-between bg-gradient-to-b from-[#7C3AED] to-[#2E1065] text-white p-6 rounded-xl shadow-md">
        <div>
          <img src={QuoteIcon} alt="quote" className="w-8 h-6 mb-4" />
      ...
      <div>
        <div className="px-4 sm:px-6 md:px-8 lg:px-[64px]">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6 mb-8">
            ...
            <div className="text-gray-500 font-inter text-[15px] sm:text-[16px] md:text-[18px] leading-[24px] sm:leading-[26px] md:leading-[28px] tracking-[-0.02em] text-center lg:text-left basis-[40%]">
